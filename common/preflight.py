...
def check_orphan_web_browser() -> Dict[str, object]:
    """Report a leaked persistent Chromium still holding the CDP port.
    ...
    recorded pid is still alive, surface it as an actionable cleanup finding.
    ...
    return {
        ...
        "pid": pid,
        "cdp_url": cdp_url,
        "error": f"Leaked persistent Chromium still running (pid {pid}, {cdp_url})",
